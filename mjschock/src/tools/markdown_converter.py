...
class MarkdownConverter:
    ...
    def to_pdf_weasyprint(self, output_file: str = None):
        ...
        html = markdown.markdown(self.markdown_content, extensions=['tables', 'fenced_code'])
...
if __name__ == "__main__":
    converter = MarkdownConverter("resume.md")
    converter.to_pdf_pandoc("resume_pandoc.pdf")
    converter.to_pdf_weasyprint("resume_weasyprint.pdf")
    converter.to_docx("resume.docx")
